import { Filter, FileDown, MoreHorizontal, Plus, Search } from 'lucide-react';
    ...
    <main className='max-w-6xl mx-auto space-y-5'>
      <div className='flex items-center gap-3'>
        ...
        <Dialog.Root>
          ...
          <Dialog.Portal>
          <Dialog.Overlay className='fixed inset-0 bg-black/78'/>
          <Dialog.Content className='fixed space-y-10 p-10 right-0 top-0 bottom-0 h-screen min-w-[320px] z-10 bg-zinc-950 border-l border-zinc-400'>
